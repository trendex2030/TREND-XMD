...
const update = async (m, sock) => {
    ...
    try {
        const { data: commitData } = await axios.get('https://api.github.com/repos/trendex2030/TREND-XMD/commits/main');
        ...
        const zipUrl = 'https://github.com/trendex2030/TREND-XMD/archive/refs/heads/main.zip';
        ...
        const sourceDir = path.join(extractTo, 'TREND-XMD-main');
