...
Matrix.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
        ...
        if (initialConnection) {
            console.log(chalk.green("Connected Successfully TREND-X 🤍"));
            Matrix.sendMessage(Matrix.user.id, { 
                image: { url: "https://files.catbox.moe/wh3gx1.jpg" }, 
                caption: `*Hello there TREND-X V2 User! 👋🏻* 

> Simple, Straightforward, But Loaded With Features 🎊. Meet TREND-X V2 WhatsApp Bot.

*Thanks for using TREND-X V2 🚩* 
