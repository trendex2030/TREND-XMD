...
global.channelLink = "https://whatsapp.com/channel/0029Vb6b7ZdF6sn4Vmjf2X1O";
global.ytch = "";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: '0029Vb6b7ZdF6sn4Vmjf2X1O@newsletter',
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '0029Vb6b7ZdF6sn4Vmjf2X1O@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '0029Vb6b7ZdF6sn4Vmjf2X1O@newsletter';
